...
class MainWidget(RelativeLayout):
    ...
    def __init__(self,**kwargs):
        ...
        Clock.schedule_interval(self.update,1/45)

    def init_audio(self):
        self.sound_my_app=SoundLoader.load('iron_man.wav')
        self.sound_my_app.volume = .8
    def is_desktop(self):
